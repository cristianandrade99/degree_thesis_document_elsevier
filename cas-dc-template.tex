...
\caption{Reconstructed fingerprints}
\label{fig6}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.3]{figs/roc_comparison.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.3]{figs/cmc_comparison.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.3]{figs/mean_qualities.jpg}}
